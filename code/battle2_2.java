...
public class battle2_2 implements Initializable{
	@FXML
	ImageView _hero;
	@FXML
	ImageView _enemy;
...
;
	...
	public void fight() throws InterruptedException {
		...
		if(enemy1.getHp() > 0){
			Timeline delay = new Timeline(new KeyFrame(Duration.millis(700), (a) -> {
			...
			TimeUnit.SECONDS.sleep((long) 0.5);
			TimeUnit.SECONDS.sleep((long) 0.5);
			Timeline delay1 = new Timeline(new KeyFrame(Duration.millis(1400), (a) -> {
				_enemy.setLayoutX(_enemy.getLayoutX() + 150);
			}));
			delay1.play();
			TimeUnit.SECONDS.sleep((long) 0.5);
	...
	public void showhp() {
		text.setText(Integer.toString(game2.hero1.Hp)+"/15");
		if(game2.hero1.Hp==14) {
			hp15.setStyle("-fx-background-color: red;");
		}else if(game2.hero1.Hp==13) {
			hp14.setStyle("-fx-background-color: red;");
			hp15.setStyle("-fx-background-color: red;");
		}else if(game2.hero1.Hp==12) {
			hp13.setStyle("-fx-background-color: red;");
			hp14.setStyle("-fx-background-color: red;");
			hp15.setStyle("-fx-background-color: red;");
		}else if(game2.hero1.Hp==11) {
			hp12.setStyle("-fx-background-color: red;");
			hp13.setStyle("-fx-background-color: red;");
			hp14.setStyle("-fx-background-color: red;");
			hp15.setStyle("-fx-background-color: red;");
		}else if(game2.hero1.Hp==10) {
			hp11.setStyle("-fx-background-color: red;");
			hp12.setStyle("-fx-background-color: red;");
			hp13.setStyle("-fx-background-color: red;");
			hp14.setStyle("-fx-background-color: red;");
			hp15.setStyle("-fx-background-color: red;");
		}else if(game2.hero1.Hp==9) {
			hp10.setStyle("-fx-background-color: red;");
			hp11.setStyle("-fx-background-color: red;");
			hp12.setStyle("-fx-background-color: red;");
			hp13.setStyle("-fx-background-color: red;");
