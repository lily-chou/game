...
public class battle3_2 implements Initializable{
	@FXML
	ImageView _hero;
	@FXML
	ImageView _enemy;
	...
	public void e_hp() {
		if(enemy1.getHp()==13) {
			e_hp14.setStyle("-fx-background-color: red;");
			e_hp15.setStyle("-fx-background-color: red;");
		}else if(enemy1.getHp()==12) {
			e_hp13.setStyle("-fx-background-color: red;");
			e_hp14.setStyle("-fx-background-color: red;");
			e_hp15.setStyle("-fx-background-color: red;");
		}else if(enemy1.getHp()==11) {
			e_hp12.setStyle("-fx-background-color: red;");
			e_hp13.setStyle("-fx-background-color: red;");
			e_hp14.setStyle("-fx-background-color: red;");
			e_hp15.setStyle("-fx-background-color: red;");
		}else if(enemy1.getHp()==10) {
			e_hp11.setStyle("-fx-background-color: red;");
			e_hp12.setStyle("-fx-background-color: red;");
			e_hp13.setStyle("-fx-background-color: red;");
			e_hp14.setStyle("-fx-background-color: red;");
			e_hp15.setStyle("-fx-background-color: red;");
		}else if(enemy1.getHp()==9) {
